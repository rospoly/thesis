...
In our framework, we embed the state-of-the-art for worst-case roundoff error analysis in the design of linear time invariant (LTI) Model Predictive Controllers (MPC)~\cite{mpc}.
%
